...
import {
  Github, Linkedin, Mail, Database, Globe, Code2, ExternalLink,
  Wrench, Layers, BookOpen, Check, FileText, BarChart3
} from 'lucide-react';
import './App.css';
...
function App() {
  ...
  const handleCopy = () => {
    navigator.clipboard.writeText("umbarkarkartik8@gmail.com");
    setCopied(true);
  ...
  const skillsCategories = [
    {
      title: "Data Analytics", icon: <BarChart3 size={20} />, color: "var(--accent-3)",
      items: ["SQL", "Data Analysis", "Data Visualization", "Statistics", "Power Query"]
    },
    {
      title: "Languages", icon: <Code2 size={20} />, color: "var(--accent-4)",
      items: ["Python", "C", "C++"]
    },
    {
      title: "Core Subjects", icon: <BookOpen size={20} />, color: "var(--accent-1)",
      items: ["DBMS", "DSA", "OOP", "Computer Networks (CNS)", "Operating Systems (OS)"]
    },
    {
      title: "Frontend Technologies", icon: <Globe size={20} />, color: "var(--accent-2)",
      items: ["HTML", "CSS", "JavaScript", "React"]
    },
    {
      title: "Backend & Databases", icon: <Database size={20} />, color: "var(--accent-3)",
      items: ["Node.js", "Express.js", "REST API", "MySQL", "PostgreSQL", "Microsoft SQL Server", "MongoDB"]
    },
    {
      title: "Tools & Platforms", icon: <Wrench size={20} />, color: "var(--accent-1)",
  ...
  const projects = [
    {
      ...
      year: "2026",
      link: "https://github.com/kartik-86/UPI-Transaction-Dashboard-PowerBI",
      details: [
    ...
    },
    {
      ...
      year: "2026",
      link: "https://github.com/kartik-86/Superstore-Sales-Dashboard-Tableau",
      details: [
    ...
    },
    {
      ...
      year: "2024",
      link: "https://github.com/kartik-86/MSRTC",
      details: [
    ...
    },
    {
      ...
      year: "2024",
      link: "https://github.com/kartik-86/Chatting-App-",
      details: [
